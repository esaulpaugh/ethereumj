...
import static org.ethereum.util.rlp.OORLP.*;
...
public class NewRLPTest2 {
    ...
    public void test4() {
        ...
        byte[] data = encodeAsItem((byte) 0).encoding();
        assertArrayEquals(expected, data);

        byte[] expected2 = {(byte) 0x78};
        data = encodeAsItem((byte) 120).encoding();
        assertArrayEquals(expected2, data);

        byte[] expected3 = {(byte) 0x7F};
        data = encodeAsItem((byte) 127).encoding();
    ...
    public void test5() {
        ...
        data = encodeAsItem((short) 30303).encoding();
        assertArrayEquals(expected4, data);

        byte[] expected5 = {(byte) 0x82, (byte) 0x4E, (byte) 0xEA};
        data = encodeAsItem((short) 20202).encoding();
    ...
    public void testEncodeInt() {
        ...
        byte[] expected = {(byte) 0x00};
        byte[] data = encodeAsItem(0).encoding();
        assertArrayEquals(expected, data);
        assertEquals(0, decodeInt(data, 0));

        byte[] expected2 = {(byte) 0x78};
        data = encodeAsItem(120).encoding();
        assertArrayEquals(expected2, data);
        assertEquals(120, decodeInt(data, 0));

        byte[] expected3 = {(byte) 0x7F};
        data = encodeAsItem(127).encoding();
        assertArrayEquals(expected3, data);
        assertEquals(127, decodeInt(data, 0));

        assertEquals(256, decodeInt(encodeAsItem(256).encoding(), 0));
        assertEquals(255, decodeInt(encodeAsItem(255).encoding(), 0));
        assertEquals(127, decodeInt(encodeAsItem(127).encoding(), 0));
        assertEquals(128, decodeInt(encodeAsItem(128).encoding(), 0));

        data = encodeAsItem(1024).encoding();
        assertEquals(1024, decodeInt(data, 0));

        byte[] expected4 = {(byte) 0x82, (byte) 0x76, (byte) 0x5F};
        data = encodeAsItem(30303).encoding();
        assertArrayEquals(expected4, data);
        assertEquals(30303, decodeInt(data, 0));

        byte[] expected5 = {(byte) 0x82, (byte) 0x4E, (byte) 0xEA};
        data = encodeAsItem(20202).encoding();
        assertArrayEquals(expected5, data);
        assertEquals(20202, decodeInt(data, 0));

        byte[] expected6 = {(byte) 0x83, 1, 0, 0};
        data = encodeAsItem(65536).encoding();
        assertArrayEquals(expected6, data);
        assertEquals(65536, decodeInt(data, 0));

        byte[] expected8 = {(byte) 0x84, (byte) 0x7F, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF};
        data = encodeAsItem(Integer.MAX_VALUE).encoding();
        assertArrayEquals(expected8, data);
        assertEquals(Integer.MAX_VALUE, decodeInt(data, 0));
    }

//    @Test(expected = RuntimeException.class)
//    public void incorrectZero() {
//        decodeInt(new byte[]{(byte)0x80}, 0);
//    }
    ...
    public void cannotEncodeNegativeNumbers() {
        encodeAsItem(Integer.MIN_VALUE);
    }

    @Test
    public void testMaxNumerics() {
        int expected1 = Integer.MAX_VALUE;
        assertEquals(expected1, decodeInt(encodeAsItem(expected1).encoding(), 0));
        short expected2 = Short.MAX_VALUE;
        assertEquals(expected2, decodeShort(encodeAsItem(expected2).encoding(), 0));
        long expected3 = Long.MAX_VALUE;
        assertEquals(expected3, decodeLong(encodeAsItem(BigInteger.valueOf(expected3)).encoding(), 0));
    }
    ...
    public void test6() {
        ...
        byte[] data = encodeAsItem(BigInteger.ZERO).encoding();
        assertArrayEquals(expected, data);
    }
    ...
    public void test7() {
        ...
        byte[] data = encodeAsItem("", UTF_8).encoding();
        ...
        data = encodeAsItem(test, UTF_8).encoding();
        ...
        data = encodeAsItem(test2, UTF_8).encoding();
        assertArrayEquals(expected2, data);
        ...
        data = encodeAsItem(test3, UTF_8).encoding();
        assertArrayEquals(expected3, data);
    }
    ...
    public void test8() {
        ...
        assertEquals(expected, Hex.toHexString(encodeAsItem(byteArray).encoding()));
    }
    ...
    public void test9() {
        ...
        byte[] actuals = encodeAsList(new byte[] {}).encoding();
    ...
    public void testEncodeElementNull() {
        ...
        byte[] actuals = encodeAsItem((byte[]) null).encoding();
//        assertArrayEquals(new byte[]{(byte) 0x80}, actuals);
    ...
    public void testEncodeElementZero() {
        ...
        byte[] actuals = encodeAsItem(new byte[]{0x00}).encoding();
    ...
    public void testEncodeElementOne() {
        ...
        byte[] actuals = encodeAsItem(new byte[]{0x01}).encoding();
   ...
   /* 2 */
        byte[] prevHash =
                {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        ...
                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        prevHash = encodeAsItem(prevHash).encoding();

   /* 2 */
        byte[] uncleList = HashUtil.sha3(encodeAsList(new byte[]{}).encoding());
   ...
   /* 3 */
        byte[] coinbase =
                {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x00, 0x00};
        coinbase = encodeAsItem(coinbase).encoding();

        byte[] header = encodeAsList(
                encodeAsItem(prevHash), encodeAsItem(uncleList), encodeAsItem(coinbase)).encoding();
...
//    }
    ...
    public void test12() {
        ...
        NewRLPList list = decodeList(payload);
    ...
    public void testEncodeEmptyString() {
        String test = "";
        String expected = "80";
        byte[] encoderesult = encodeAsItem(test, UTF_8).encoding();
        assertEquals(expected, Hex.toHexString(encoderesult));

        String decodeResult = new String(decode(encoderesult, 0).data(), UTF_8);
    ...
    public void testEncodeShortString() {
        ...
        byte[] decodeResult = decode(encoderesult, 0).data();
    ...
    public void testEncodeLongString() {
        ...
        byte[] decodeResult = (byte[]) decode(encoderesult, 0).data();
        assertEquals(test, bytesToAscii(decodeResult));
    }
    ...
    public void testEncodeZero() {
        Integer test = 0;
        String expected = "00";
        byte[] encoderesult = encodeAsItem(test).encoding();
        assertEquals(expected, Hex.toHexString(encoderesult));
    ...
    public void testEncodeMediumInteger() {
        ...
        test = 1024;
        expected = "820400";
        encoderesult = encodeAsItem(test).encoding();
        assertEquals(expected, Hex.toHexString(encoderesult));

        decodeResult = (byte[]) decode(encoderesult, 0).data();
    ...
    public void TestEncodeEmptyList() {
        ...
        String expected = "c0";
        byte[] encoderesult = encodeAsList(test).encoding();
        assertEquals(expected, Hex.toHexString(encoderesult));
    ...
    public void testEncodeShortStringList() {
        ...
        byte[] encoderesult = encodeAsList(encodeAsItem(test[0], UTF_8), encodeAsItem(test[1], UTF_8)).encoding();
        assertEquals(expected, Hex.toHexString(encoderesult));

        List<NewRLPElement> decodeResult = decodeList(encoderesult, 0).elements();
        assertEquals("cat", bytesToAscii(decodeResult.get(0).data()));
        assertEquals("dog", bytesToAscii(decodeResult.get(1).data()));

        test = new String[]{"dog", "god", "cat"};
        expected = "cc83646f6783676f6483636174";
        encoderesult = encodeAsList(encodeAsItem(test[0], UTF_8), encodeAsItem(test[1], UTF_8), encodeAsItem(test[2], UTF_8)).encoding();
        assertEquals(expected, Hex.toHexString(encoderesult));

        decodeResult = decodeList(encoderesult, 0).elements();
        assertEquals("dog", bytesToAscii(decodeResult.get(0).data()));
        assertEquals("god", bytesToAscii(decodeResult.get(1).data()));
        assertEquals("cat", bytesToAscii(decodeResult.get(2).data()));
    }
    ...
    public void testEncodeLongStringList() {
        ...
        List<NewRLPElement> decodeResult = decodeList(encoderesult, 0).elements();
        assertEquals(element1, bytesToAscii(decodeResult.get(0).data()));
        assertEquals(element2, bytesToAscii(decodeResult.get(1).data()));
    }
...
//        Object[] test = new Object[]{1, new Object[]{"cat"}, "dog", new Object[]{2}};
        NewRLPElement[] test = new NewRLPElement[] {
                encodeAsItem(1), encodeAsList(encodeAsItem("cat", UTF_8)), encodeAsList(encodeAsItem("dog", UTF_8)), encodeAsList(new byte[2])
        };
        String expected = "cc01c48363617483646f67c102";
        byte[] encoderesult = encodeAsList(test).encoding();
        assertEquals(expected, Hex.toHexString(encoderesult));

        NewRLPList decodeResult = decodeList(encoderesult, 0);
        List<NewRLPElement> elements = decodeResult.elements();
        assertEquals(1, byteArrayToInt(elements.get(0).data()));
        assertEquals("cat", bytesToAscii(((NewRLPList) elements.get(1)).elements().get(0).data()));
        assertEquals("dog", bytesToAscii(elements.get(2).data()));
        assertEquals(2, byteArrayToInt(((NewRLPList) elements.get(2)).elements().get(0).data()));
...
//    }
    ...
    public void testRlpEncode() {
        ...
        assertEquals(result01, Hex.toHexString(encodeAsItem(test01).encoding()));
        assertEquals(result02, Hex.toHexString(encodeAsItem(test02, UTF_8).encoding()));
        assertEquals(result03, Hex.toHexString(encodeAsItem(test03, UTF_8).encoding()));
        assertEquals(result04, Hex.toHexString(encodeAsItem(test04, UTF_8).encoding()));
        assertEquals(result05, Hex.toHexString(encodeAsItem(test05, UTF_8).encoding()));
        // TODO ***********************************
//        assertEquals(result06, Hex.toHexString(encodeAsList(test06, UTF_8).encoding()));
//        assertEquals(result07, Hex.toHexString(encodeAsList(test07, UTF_8).encoding()));
        assertEquals(result08, Hex.toHexString(encodeAsItem(test08).encoding()));
        assertEquals(result09, Hex.toHexString(encodeAsItem(test09).encoding()));
        assertEquals(result10, Hex.toHexString(encodeAsItem(test10).encoding()));
        assertEquals(result11, Hex.toHexString(encodeAsItem(test11).encoding()));
        assertEquals(result12, Hex.toHexString(encodeAsItem(test12).encoding()));
        assertEquals(result13, Hex.toHexString(encodeAsItem(test13).encoding()));
        // TODO ************************************
//        assertEquals(result14, Hex.toHexString(encodeAsItem(test14).encoding()));
//        assertEquals(result15, Hex.toHexString(encodeAsItem(test15).encoding()));
//        assertEquals(result16, Hex.toHexString(encodeAsItem(test16).encoding()));
    }
    ...
    public void testRlpDecode() {
        ...
        emptyString = new String(decode(Hex.decode(result01), pos).data(), UTF_8);
        assertEquals("\0", emptyString);

        emptyString = new String(decode(Hex.decode(result02), pos).data());
        assertEquals(test02, emptyString);

        decodedData = decode(Hex.decode(result03), pos).data();
        assertEquals(test03, bytesToAscii(decodedData));

        decodedData = decode(Hex.decode(result04), pos).data();
        assertEquals(test04, bytesToAscii(decodedData));

        decodedData = decode(Hex.decode(result05), pos).data();
        assertEquals(test05, bytesToAscii(decodedData));

        // TODO ************************************
//        decodedList = (Object[]) decode(Hex.decode(result06), pos).data();
//        assertEquals(test06[0], bytesToAscii((byte[]) decodedList[0]));
//        assertEquals(test06[1], bytesToAscii((byte[]) decodedList[1]));
//
//        decodedList = (Object[]) decode(Hex.decode(result07), pos).data();
...
//        assertEquals(test07[2], bytesToAscii((byte[]) decodedList[2]));
        ...
        // 1
        decodedData = decode(Hex.decode(result08), pos).data();
        assertEquals(test08, byteArrayToInt(decodedData));

        // 10
        decodedData = decode(Hex.decode(result09), pos).data();
        assertEquals(test09, byteArrayToInt(decodedData));

        // 100
        decodedData = decode(Hex.decode(result10), pos).data();
        assertEquals(test10, byteArrayToInt(decodedData));

        // 1000
        decodedData = decode(Hex.decode(result11), pos).data();
        assertEquals(test11, byteArrayToInt(decodedData));

        decodedData = decode(Hex.decode(result12), pos).data();
        assertTrue(test12.compareTo(new BigInteger(1, decodedData)) == 0);

        decodedData = decode(Hex.decode(result13), pos).data();
...
//        Object testObject1 = decode(Hex.decode(result14), pos).data();
//        assertTrue(DeepEquals.deepEquals(expected14, testObject1));
//
//        Object testObject2 = decode(Hex.decode(result15), pos).data();
//        assertTrue(DeepEquals.deepEquals(test15, testObject2));
//
//        // Need to test with different expected value, because decoding doesn't recognize types
//        Object testObject3 = decode(Hex.decode(result16), pos).data();
//        assertTrue(DeepEquals.deepEquals(expected16, testObject3));
    ...
    public void testEncodeLength() {
        ...
        int length = 1;
        int offset = 128;
        byte[] encodedLength = encodeAsItem(length).encoding();
        String expected = "81";
        ...
        length = 56;
        offset = 192;
        encodedLength = encodeAsList(new byte[0]).encoding();
        expected = "f838";
        assertEquals(expected, Hex.toHexString(encodedLength));
    }
    ...
    public void unsupportedLength() {
        ...
        try {
            encodedLength = encodeAsItem((int) maxLength).encoding();
    ...
    public void performanceDecode() throws IOException {
        ...
        if (performanceEnabled) {
            ...
            NewRLPList list = null;
            NewRLPElement result = null;
            ...
            for (int i = 0; i < ITERATIONS; i++) {
                list = decodeList(payload);
                list.elements();
            }
            long end2 = System.currentTimeMillis();

            System.out.println("Result OOdecode()\t: " + (end1 - start1) + "ms and\t " + determineSize(result.data()) + " bytes for each resulting object list");
            System.out.println("Result OORLP.decodeList()\t: " + (end2 - start2) + "ms and\t " + determineSize(list.data()) + " bytes for each resulting object list");
        } else {
            System.out.println("Performance test for OORLP.decode() disabled");
        }
    }
    ...
    public void encodeEdgeShortList() {
        ...
        byte[] output = encodeAsList(encodeAsItem(rlpKeysList), encodeAsItem(rlpValuesList), encodeAsItem(rlpCode)).encoding();
    ...
    public void encodeBigIntegerEdge_1() {
        ...
        byte[] encodedData = encodeAsItem(integer).encoding();
...
//
//        Set<ByteArrayWrapper> data = new HashSet<>();
//        byte[] setEncoded = encodeAsItem(data);
//        assertEquals("c0", Hex.toHexString(setEncoded));
//    }

    @Test
    public void testEncodeInt_7f(){
        String result =  Hex.toHexString(encodeAsItem(0x7f).encoding());
        String expected = "7f";
    ...
    public void testEncodeInt_80(){
        String result =  Hex.toHexString(encodeAsItem(0x80).encoding());
    ...
    public void testEncode_ED(){
        String result =  Hex.toHexString(encodeAsItem(0xED).encoding());
    ...
    public void partialDataParseTest() {
        ...
        NewRLPElement element = decode(Hex.decode(hex), 3);
        assertEquals(1, element.getDataLength());
//        assertEquals(0, Util.rlpDecodeInt(element.data()));
    }
    ...
    public void shortStringRightBoundTest(){
        ...
        byte[] rlpEncoded = encodeAsItem(testString, UTF_8).encoding();
        String res = new String(decode(rlpEncoded, 0).data());
    ...
    public void encodeDecodeBigInteger() {
        ...
        byte[] encoded = encodeAsItem(expected).data();
    ...
    public void rlpEncodedLength() {
        ...
        try {
            NewRLPList res = decodeList(rlpBomb);
        } catch (Exception ex) {
            // decodeList is protected!
            Throwable cause = ex;
            while (cause != null) {
        ...
        isProtected = false;
        try {
            Object decoded = decode(rlpBomb, 0).data();
        } catch (Exception ex) {
